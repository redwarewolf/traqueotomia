...
Sildar’s plan is to get some rest at the Stonehill Inn, then search Phandalin for signs of the missing wizard, Iarno Albrek. When his investigation hits a dead end, he sets up a meeting with Townmaster Harbin Wester (see the “[Townmaster’s Hall](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#TownmastersHall)” section).

During this part of the adventure, the characters can visit the various locations in Phandalin and talk to the NPCs there. (See the “[Town Description](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#TownDescription)” section for details.) The town is small enough that it takes only a few minutes to stroll from one end to the other. However, the characters arrive late in the day and can’t get to more than one or two locations before it’s time to seek lodgings for the night.

Some locales the characters should visit include the following:

- **[Barthen’s Provisions.](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#BarthensProvisions)** If the characters have the wagonload of supplies from the “[Meet Me in Phandalin](https://www.dndbeyond.com/sources/lmop/introduction#AdventureHook)” adventure hook, they are meant to deliver it to this shop.
- **[Lionshield Coster.](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#LionshieldCoster)** If the characters retrieved the stolen goods from the Cragmaw hideout, they might want to return them to the rightful owner.
- **[Stonehill Inn.](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#StonehillInn)** If the characters have Sildar Hallwinter with them, the knight suggests heading for this inn to find lodgings. If the characters are otherwise looking for a place to eat and sleep, they discover that the Stonehill appears to be the best available option.

## [Encounters in Phandalin](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#EncountersinPhandalin)
...
## [Important NPCs](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#ImportantNPCs)
...
[Sildar Hallwinter](https://www.dndbeyond.com/monsters/22033-sildar-hallwinter): Member of the Lords’ Alliance with two quests for the party

### [Roleplaying Phandalin NPCs](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RoleplayingPhandalinNPCs)
...
The characters have no reason to fight ordinary townsfolk. Hence, no game statistics are provided for them. If statistics become necessary, use the [commoner](https://www.dndbeyond.com/monsters/16829-commoner) stat block to represent an adult NPC of any race.

## [Town Description](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#TownDescription)

Phandalin is small, so the characters can visit multiple locations and NPCs throughout a given day. If the players choose to have their characters split up, they can cover more ground, but you’ll have to take turns running each interaction for each player. Splitting the party also makes the “[Redbrand Ruffians](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RedbrandRuffians)” encounter potentially more dangerous.
...
- Narth, an old farmer: “Sister Garaele, who oversees the Shrine of Luck, recently left town for a few days, then returned wounded and exhausted.” (See the “[Shrine of Luck](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#ShrineofLuck)” section for more information.)
...
[![](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/map-2.1-Phandalin.jpg)](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/map-2.1-Phandalin.jpg)
...
#### [Joining the Zhentarim](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#JoiningtheZhentarim)
...
### [Alderleaf Farm](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#AlderleafFarm)
...
_**Quest: The Banshee’s Bargain.**_ Recently, Garaele’s superiors asked her to undertake a delicate mission. They wanted her to persuade a [banshee](https://www.dndbeyond.com/monsters/17089-banshee) named Agatha to answer a question about a spellbook. Garaele sought out Agatha in her lair, but the creature did not appear for her.
...
#### [Joining the Harpers](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#JoiningtheHarpers)
...
### [The Sleeping Giant](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#TheSleepingGiant)

This rundown tap house is a dirty, dangerous watering hole at the end of Phandalin’s main street. It is frequented by Redbrand thugs and operated by a surly female dwarf named Grista. If the characters choose to visit the place, run the “[Redbrand Ruffians](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RedbrandRuffians)” encounter.

### [Townmaster’s Hall](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#TownmastersHall)
...
#### [Joining the Lords’ Alliance](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#JoiningtheLordsAlliance)
...
### [Tresendar Manor](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#TresendarManor)
...
## [Redbrand Ruffians](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RedbrandRuffians)
...
- The characters decide to investigate Tresendar Manor. Skip the encounter and go straight to “[Redbrand Hideout.”](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RedbrandHideout)
...
### [Confrontation](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#Confrontation)
...
The group consists of four [Redbrand ruffians](https://www.dndbeyond.com/monsters/22030-redbrand-ruffian). If three of them are defeated, the last one flees toward Tresendar Manor.

#### [Developments](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RedbrandRuffiansDevelopments)

Redbrands who are captured or [charmed](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#CharmedCondition) by the characters can impart useful information. (See the “[What the Redbrands Know](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#WhatTheRedbrandsKnow)” sidebar below.) Townmaster Harbin Wester won’t want to keep Redbrand prisoners until he knows the whole gang has been defeated, but the characters can easily persuade or intimidate him into locking up any prisoners they capture for at least a few days.
...
If the characters begin their search at Tresendar Manor, they enter the dungeon in [area 1](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#1Cellar). If they instead follow Carp Alderleaf to the secret tunnel the lad found, they enter the dungeon by way of [area 8](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#8Crevasse).

[![](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/map-2.2-Redbrand-Hideout.jpg)](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/map-2.2-Redbrand-Hideout.jpg)

Redbrand Hideout[View Player Version](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/map-2.2-Redbrand-Hideout-player.jpg)

### [General Features](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GeneralFeatures)
...
_**Doors.**_ All doors are made of wood with iron handles, hinges, and built-in locks. They are unlocked unless the text states otherwise. Iarno Albrek ([area 12](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#12GlasstaffsQuarters)) and a bugbear named Mosk (area 9) each carry an iron key that can lock or unlock every door in the complex.
...
Secret doors are made of stone and blend in with the surrounding walls. Spotting a secret door from a distance of no more than 10 feet without actively searching for it requires a passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score of 15 or higher, whereas a character who takes the time to search the wall can find the secret door with a successful DC 10 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. Secret doors swing open on hidden iron hinges and are not locked.
...
- The leader of the Redbrands is a human wizard known as Glasstaff, so named because his magic staff is made of glass. (Only Iarno Albrek and the Black Spider know Glasstaff’s real name.) Glasstaff’s chambers are in the western end of the stronghold (see [areas 11](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#11WizardsWorkshop) andarea [12](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#12GlasstaffsQuarters)).
- A mysterious figure called the Black Spider has hired the Redbrands to frighten off adventurers and intimidate the locals, for reasons unknown. The Black Spider has sent bugbears to reinforce the Redbrands and provide extra muscle (see [area 9](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#9GuardBarracks)).
...
A waterproof satchel hangs from a submerged rope attached along the south wall of the cistern, about 2 feet below the surface of the water. It’s not visible from above the water, but can be found with a successful DC 15 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check or automatically by a character probing the cistern with a pole or jumping in. The satchel contains some valuable items (see the “Treasure” section).
...
Three [Redbrand ruffians](https://www.dndbeyond.com/monsters/22030-redbrand-ruffian) are resting in this room. If they hear a good deal of noise in area 1 (including loud voices or barrels being rolled around), they prepare themselves for a fight and try to surprise intruders.
...
The pit trap in the middle of the hallway is hidden under a false floor consisting of loose stone tiles laid atop breakaway timbers. The tiles and timbers collapse under 100 or more pounds of weight. A character searching the hall for traps can spot the covered pit with a successful DC 15 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. A successful check also reveals narrow ledges on the north and south sides of the pit. A creature attempting to skirt around the pit using one of these ledges must succeed on a DC 10 Dexterity ([Acrobatics](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check.
...
The three [skeletons](https://www.dndbeyond.com/monsters/17015-skeleton) are animated and attack any creature that comes within 10 feet of the door leading to area 5 or the door leading to [area 6](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#6Armory), unless that creature is wearing the scarlet cloak of the Redbrands or speaks the password “Illefarn” (the name of an ancient elven nation, which once spread across much of the Sword Coast).
...
Two [Redbrand ruffians](https://www.dndbeyond.com/monsters/22030-redbrand-ruffian) in scarlet cloaks stand guard here, though they spend most of their time taunting the hapless prisoners (see the “[Captives](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#Captives)” section). If they hear fighting in area 5, they take up positions against the wall near the door, then try to surprise intruders. The captives are too intimidated to shout warnings or call for help.
...
The Dendrars are grateful to the characters for rescuing them, but they can’t provide much information about the Redbrand hideout. All they know is that the boss is a wizard (though they haven’t met him and don’t know his name), and that he has “tall, furry monsters with big ears” ([bugbears](https://www.dndbeyond.com/monsters/16817-bugbear)) working for him.

_**Side Quest: Mirna’s Heirloom.**_ Though her family has nothing to offer as a reward, Mirna tells the characters that she might know where a valuable heirloom is hidden. When she was a young girl, she and her family fled from the town of Thundertree after undead overran the place. Her family had an herb and alchemy shop, inside which a case containing an emerald necklace was hidden beneath a section of storage shelves. She never dared to return and retrieve it. The shop was in the southeast part of Thundertree. If the characters decide to explore the ruins of Thundertree, see [part 3](https://www.dndbeyond.com/sources/lmop/the-spiders-web#RuinsofThundertree) of the adventure.

#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#SlavePensExperiencePoints)Awarding Experience Points
...
### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#6Armory)6. Armory

The door to this room is locked from the outside. Across from the locked door is a secret door that leads to area 7. For more information on locked doors and secret doors, see the “[General Features](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GeneralFeatures)” section above.
...
The weapon racks hold twelve [spears](https://www.dndbeyond.com/equipment/14-spear), six [shortswords](https://www.dndbeyond.com/equipment/30-shortsword), four [longswords](https://www.dndbeyond.com/equipment/4-longsword), six [light crossbows](https://www.dndbeyond.com/equipment/15-crossbow-light), and eight [quivers](https://www.dndbeyond.com/equipment/73-quiver) holding twenty crossbow bolts each.

### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#7StoreroomandWorkArea)7. Storeroom and Work Area
...
This room contains two secret doors, one leading to area 6 and the other to [area 12](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#12GlasstaffsQuarters). See the “[General Features](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GeneralFeatures)” section above for more information on secret doors.

#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#StoreroomandWorkAreaTreasure)Treasure
...
The nothic communicates using telepathy. If detected, it prefers to negotiate and isn’t above betraying the Redbrands for the right incentive, such as the promise of food. When roleplaying the nothic, consider speaking in whispers and throwing in some mad cackles and bits of gibberish. Also be sure to mention that the creature isn’t actually talking but rather filling the characters’ heads with its foul murmurings and demands for food. The nothic knows everything the Redbrands know; see the “[What the Redbrands Know](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#WhatTheRedbrandsKnow)” sidebar above.

_**Bridges.**_ These bridges are made of wooden planks and have no rails. The south one is rigged to collapse when a creature weighing more than 50 pounds moves across it. A character next to the bridge can discern that the construction is faulty with a successful DC 15 Intelligence ([Investigation](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. Any creature can use an action to dislodge one end of either bridge, dropping it into the crevasse.

[![](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/02-002.nothic.png)](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/02-002.nothic.png)

Nothic

_**Crevasse.**_ This steep-sided fissure is 5 to 10 feet wide and 20 feet deep. Its rough walls are easily climbed without an ability check. A creature that falls into the crevasse takes 2d6 bludgeoning damage and lands [prone](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ProneCondition) in a jumble of rubble that is [difficult terrain](https://www.dndbeyond.com/sources/basic-rules/adventuring#DifficultTerrain) (see “[Difficult Terrain](https://www.dndbeyond.com/sources/basic-rules/combat#DifficultTerrain)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)).

The bottom of the crevasse feels unnaturally cold. When viewed with a [detect magic](https://www.dndbeyond.com/spells/2065-detect-magic) spell, the area emanates a faint necromantic aura. The magic causes all organic matter in the crevasse to age and decompose at half the normal rate.
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#CrevasseExperiencePoints)Awarding Experience Points
...
Three [bugbears](https://www.dndbeyond.com/monsters/16817-bugbear) and one [goblin](https://www.dndbeyond.com/monsters/16907-goblin) are present. The goblin, Droop, falls [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition) at the sight of the party, but another creature can use an action to wake him. Otherwise, Droop remains [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition) for 1d10 minutes.
...
Characters might be inclined to keep Droop around for a while. See the “[NPC Party Members](https://www.dndbeyond.com/sources/lmop/goblin-arrows#NPCPartyMembers)” sidebar in Part 1 for advice on how to run Droop as a member of the party.

#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GuardBarracksDevelopments)Developments
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GuardBarracksTreasure)Treasure
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GuardBarracksExperiencePoints)Awarding Experience Points

Divide 600 XP equally among the characters if the party defeats the bugbears.

### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#10CommonRoom)10. Common Room
...
A character who listens at the door with a successful DC 10 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check hears the villains within engaged in a game of knucklebones. This makes for a mysterious rattling sound, followed by shouts and groans and a sudden gabble of voices as wagers are paid. If the characters burst into the room, they automatically surprise its occupants.
...
Four [Redbrand ruffians](https://www.dndbeyond.com/monsters/22030-redbrand-ruffian) are drinking and playing knucklebones when the characters enter. The game isn’t far from turning acrimonious, as most of them do. The dice are loaded, and the ruffian to which they belong is naturally winning. All four have been drinking heavily, and they are [poisoned](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#PoisonedCondition) (see the [appendix](https://www.dndbeyond.com/sources/basic-rules/appendix-a-conditions#Poisoned) in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules) for the effects of being [poisoned](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#PoisonedCondition)).

The Redbrands immediately recognize characters wearing scarlet cloaks as impostors. However, fast-talking characters might still be able to pass themselves off as “new recruits,” especially if they offer to join the game. If you don’t think the players are doing a great job roleplaying the deception, you can have the character who is doing most of the talking make a DC 10 Charisma ([Deception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check to fool the Redbrands.

#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#CommonRoomTreasure)Treasure
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#CommonRoomExperiencePoints)Awarding Experience Points

Divide 400 XP equally among the characters if the party defeats the Redbrands in this room.

### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#11WizardsWorkshop)11. Wizard’s Workshop

Faint bubbling and dripping sounds can be heard through either door of this room with a successful DC 15 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check.
...
_**Books and Notes.**_ Iarno is trying to master the art of brewing potions and concocting alchemical mixtures. The books and notes scattered around the room are basic texts on alchemy. Any character proficient in [Arcana](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills) can see that Iarno’s apparatus appears to be set up to brew [potions of invisibility](https://www.dndbeyond.com/magic-items/4710-potion-of-invisibility)—not that he has succeeded so far.
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#WizardsWorkshopDevelopments)Developments
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#WizardsWorkshopTreasure)Treasure
...
If the rat in area 11 warns him that trouble is approaching, Iarno the [evil mage](https://www.dndbeyond.com/monsters/22021-evil-mage) grabs his [staff of defense](https://www.dndbeyond.com/magic-items/9090-staff-of-defense) (see [appendix A](https://www.dndbeyond.com/sources/lmop/appendix-a-magic-items#StaffofDefense)) and the scrolls in his chest (see the “Treasure” section), and flees through the secret door in the northeast corner of the room. In his haste, Iarno leaves behind a letter from the Black Spider (see the “[Developments](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#Developments)” section) and neglects to make sure the secret door is closed all the way. Characters gain [advantage](https://www.dndbeyond.com/sources/basic-rules/using-ability-scores#AdvantageandDisadvantage) on ability checks made to find the slightly ajar secret door (see “[Advantage and Disadvantage](https://www.dndbeyond.com/sources/basic-rules/using-ability-scores#AdvantageandDisadvantage)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)). For more information on secret doors, see the “[General Features](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GeneralFeatures)” section above.

If he manages to escape, Iarno flees to [area 1](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#1Cellar) (through [areas 7](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#7StoreroomandWorkArea) andarea [8](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#8Crevasse)) and grabs the satchel hidden in the cistern there. If the [nothic](https://www.dndbeyond.com/monsters/17092-nothic) is still alive in area 8, Iarno instructs it to waylay any pursuers. If the characters catch up to him, Iarno quaffs the [potion of invisibility](https://www.dndbeyond.com/magic-items/4710-potion-of-invisibility) in the satchel and flees the hideout. At your discretion, he could reappear later in the adventure.

#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#RoleplayingIarno)Roleplaying Iarno
...
[![](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/02-003.spiders.png)](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/02-003.spiders.png)

If threatened, Iarno uses his [staff of defense](https://www.dndbeyond.com/magic-items/9090-staff-of-defense) to cast [mage armor](https://www.dndbeyond.com/spells/2172-mage-armor) on himself. He then casts offensive spells at enemies he can see. [Iarno’s stat block](https://www.dndbeyond.com/monsters/22021-evil-mage) contains a list of the spells he has prepared. Iarno uses the [shield](https://www.dndbeyond.com/spells/2247-shield) power of his staff for added protection.
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#Developments)Developments
...
[![](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/02-004.spider.png)](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/02-004.spider.png)
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GlasstaffsQuartersTreasure)Treasure

At the foot of Iarno’s bed is a sturdy, unlocked wooden chest holding the best pickings of the Redbrands’ loot over the last two months. It contains 180 sp, 130 gp, and a silk pouch containing five carnelians (10 gp each), two peridots (15 gp each), and one pearl (100 gp). It also contains two magic items that Iarno brought with him from Neverwinter: a [scroll](https://www.dndbeyond.com/magic-items/5418-spell-scroll) of [charm person](https://www.dndbeyond.com/spells/2025-charm-person) and a [scroll](https://www.dndbeyond.com/magic-items/5418-spell-scroll) of [fireball](https://www.dndbeyond.com/spells/2102-fireball).
...
#### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#GlasstaffsQuartersExperiencePoints)Awarding Experience Points
...
### [](https://www.dndbeyond.com/sources/dnd/lmop/phandalin#WhatsNext)What’s Next?

The next stage of the adventure continues with [part 3, “The Spider’s Web,”](https://www.dndbeyond.com/sources/lmop/the-spiders-web) in which the characters undertake a number of short adventures that advance the story. At some point during part 2, the characters are likely to advance to 3rd level, so make sure the players are keeping track of their XP.

![[map-2.1-Phandalin.jpg]]