...
When you’re ready, continue with the “[Goblin Ambush](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GoblinAmbush)” section.

## [Goblin Ambush](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GoblinAmbush)
...
If you are using the “[Meet Me in Phandalin](https://www.dndbeyond.com/sources/lmop/introduction#AdventureHook)” adventure hook, then any character who approaches to make a closer investigation can identify the horses as belonging to Gundren Rockseeker and Sildar Hallwinter. They’ve been dead about a day, and it’s clear that arrows killed the horses. When the characters inspect the scene closer, read the following:
...
#### [Developments](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#AmbushDevelopments)

In the unlikely event that the goblins defeat the adventurers, they leave them [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition), loot them and the wagon, then head back to the Cragmaw hideout. The characters can continue on to Phandalin, buy new gear at Barthen’s Provisions, return to the ambush site, and find the goblins’ trail.

The characters might capture one or more goblins by knocking them [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition) instead of killing them. A character can use any melee weapon to knock a goblin [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition), succeeding if the attack deals enough damage to drop the goblin to 0 hit points. Once it regains consciousness after a few minutes, a captured goblin can be convinced to share what it knows (see the “[What the Goblins Know](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#WhatTheGoblinsKnow)” sidebar below). A goblin can also be persuaded to lead the party to the Cragmaw hideout while avoiding traps along the way (see the “[Goblin Trail](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GoblinTrail)” section).

The characters might not find the goblin trail, or they could decide to continue to Phandalin. In that case, skip ahead to [part 2, “Phandalin.”](https://www.dndbeyond.com/sources/lmop/phandalin) Elmar Barthen (the owner of Barthen’s Provisions) seeks out the characters and informs them that Gundren Rockseeker never arrived. He recounts the goblin troubles and suggests that the characters return to the ambush site to investigate further (after they rest). Barthen also tells the party that Linene Graywind of the Lionshield Coster (see below) can provide more information on the goblin attacks.

RESTS

The party might need to rest after the goblin ambush, depending on how the battle plays out. See the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules/adventuring#Resting) for more information on short rests and long rests.

### [Goblin Trail](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GoblinTrail)

After the characters defeat the goblins, any inspection of the area reveals that the creatures have been using this place to stage ambushes for some time. A trail hidden behind thickets on the north side of the road leads northwest. A character who succeeds on a DC 10 Wisdom ([Survival](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check recognizes that about a dozen goblins have come and gone along the trail, as well as signs of two human-sized bodies being hauled away from the ambush site.

The party can easily steer the wagon away from the road and tie off the oxen while the group pursues the goblins.

The trail leads five miles northwest and ends at the Cragmaw hideout (see that [section](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#CragmawHideout)). Ask the players to determine the party’s marching order as the characters move down the trail. The order is important, because the goblins have set two traps to thwart pursuers.

_**Snare.**_ About 10 minutes after heading down the trail, a party on the path encounters a hidden snare. If the characters are searching for traps, the character in the lead spots the trap automatically if his or her passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score is 12 or higher. Otherwise, the character must succeed on a DC 12 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check to notice the trap. If the character fails to notice the trap, he or she triggers the snare and must succeed on a DC 10 Dexterity saving throw. On a failure, the character is suspended upside down 10 feet above the ground. The character is [restrained](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#RestrainedCondition) until 1 or more slashing damage is dealt to the snare’s cord. (See the [appendix](https://www.dndbeyond.com/sources/basic-rules/appendix-a-conditions#Restrained) in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules) for the effect of being [restrained](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#RestrainedCondition).) A character who isn’t carefully lowered down takes 1d6 bludgeoning damage from the fall.

_**Pit.**_ Another 10 minutes down the trail is a pit the goblins have camouflaged. The pit is 6 feet wide, 10 feet deep, and it triggers when a creature moves across it. The character in the lead spots the hidden pit automatically if his or her passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score is 15 or higher. Otherwise, the character must succeed on a DC 15 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check to spot the hidden pit. If the trap isn’t detected, the lead character must succeed on a DC 10 Dexterity saving throw or fall in, taking 1d6 bludgeoning damage. The pit’s walls are not steep, so no ability check is required to scramble out.

### [Awarding Experience Points](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#AwardingExperiencePoints)
...
- Fewer than twenty [goblins](https://www.dndbeyond.com/monsters/16907-goblin) currently dwell in the lair.
- Their leader is a [bugbear](https://www.dndbeyond.com/monsters/16817-bugbear) named Klarg. He answers to King Grol, chief of the Cragmaw tribe, who dwells in Cragmaw Castle. (The goblins can provide basic directions to Cragmaw Castle. It’s about twenty miles northeast of the Cragmaw hideout, in Neverwinter Wood.)
...
- The dwarf and his map were delivered to King Grol, as instructed. The dwarf’s human companion is being held in the “eating cave” ([area 6](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#6GoblinDen)).

## [Cragmaw Hideout](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#CragmawHideout)
...
### [General Features](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GeneralFeatures)
...
_**Light.**_ [Areas 1](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#1CaveMouth) andarea [2](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#2GoblinBlind) are outside. The rest of the complex is dark unless stated otherwise. The boxed text for those locations assumes that the characters have [darkvision](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Darkvision) or a light source.

_**Rubble.**_ Areas of crumbling rock and gravel are [difficult terrain](https://www.dndbeyond.com/sources/basic-rules/adventuring#DifficultTerrain) (see [“Difficult Terrain”](https://www.dndbeyond.com/sources/basic-rules/combat#DifficultTerrain) in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)).

_**Sound.**_ The sound of water in the cave muffles noises to any creatures that aren’t listening carefully. Creatures can make a DC 15 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check to attempt to hear activity in nearby chambers.

_**Stalagmites.**_ These upthrust spires of rock can provide cover (see “[Cover](https://www.dndbeyond.com/sources/basic-rules/combat#Cover)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)).
...
_**Scale and Grid.**_ A scale allows you to measure distances and dimensions accurately, which is important for combat encounters, magical effects, and light sources, among other things. Indoor maps use grid squares that are either 5 feet on a side or 10 feet on a side.

_**Compass Rose.**_ A compass rose comes in handy when you’re describing locations. For instance, you might need to tell players about “barrels along the north wall” or “the staircase descending to the west.”

### [Cave Mouth](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#1CaveMouth)1. 
...
Characters moving carefully or scouting ahead might be able to surprise the goblin lookouts. Have each character who moves ahead make a Dexterity ([Stealth](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check contested by the goblins’ passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score to avoid being [surprised](https://www.dndbeyond.com/sources/basic-rules/combat#Surprise). See the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules/using-ability-scores#Contests) for more information on ability check contests.

_**Thickets.**_ The thickets around the clearing are [difficult terrain](https://www.dndbeyond.com/sources/basic-rules/adventuring#DifficultTerrain), but they aren’t dangerous—just annoying. They provide [half cover](https://www.dndbeyond.com/sources/basic-rules/combat#Cover) to creatures behind them. (See “[Difficult Terrain](https://www.dndbeyond.com/sources/basic-rules/combat#DifficultTerrain)” and “[Cover](https://www.dndbeyond.com/sources/basic-rules/combat#Cover)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules) for more information.)

### [3. Kennel](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#3Kennel)
...
Three [wolves](https://www.dndbeyond.com/monsters/17062-wolf) are confined here. They can’t reach targets standing on the steps, but all three attack any creature except a goblin that moves into the room (see the “[Developments](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#KennelDevelopments)” section). Goblins in nearby caves ignore the sounds of fighting wolves, since they constantly snap and snarl at each other.

A character who tries to calm the animals can attempt a DC 15 Wisdom ([Animal Handling](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. On a success, the wolves allow the character to move throughout the room. If the wolves are given food, the DC drops to 10.

_**Fissure.**_ A narrow opening in the east wall leads to a natural chimney that climbs 30 feet to [area 8](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#8KlargsCave). At the base of the fissure is rubbish that’s been discarded through the opening above. A character attempting to ascend or descend the chimney shaft must make a DC 10 Strength ([Athletics](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. If the check succeeds, the character moves at half speed up or down the shaft, as desired. On a check result of 6–9, the character neither gains nor loses ground; on a result of 5 or less, the character falls and takes 1d6 bludgeoning damage per 10 feet fallen, landing [prone](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ProneCondition) at the base of the shaft.

#### [Developments](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#KennelDevelopments)
...
### [4. Steep Passage](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#4SteepPassage)

From this point on, characters without [darkvision](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Darkvision) will need light to see their surroundings.
...
Characters using light or [darkvision](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Darkvision) to look farther up the passage spot the bridge at [area 5](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#5Overpass). Add:
...
Any character who can see the bridge in area 5 might also notice the goblin guarding the bridge. Doing so requires a Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check contested by the goblin’s Dexterity ([Stealth](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check.

The goblin notices the characters if they carry any light or don’t use stealth as they approach the bridge. The goblin does not attack. Instead, it attempts to sneak away to the east to inform its companions in [area 7](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#7TwinPoolsCave) to release a flood (see the “[Flood!](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#Flood)” section of area 5). The goblin moves undetected if its Dexterity ([Stealth](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check exceeds the passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score of any character who might notice its movements.

_**Western Passage.**_ This passage is choked with rubble and has steep escarpments. Treat the area as [difficult terrain](https://www.dndbeyond.com/sources/basic-rules/adventuring#DifficultTerrain) (see “[Difficult Terrain](https://www.dndbeyond.com/sources/basic-rules/combat#DifficultTerrain)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)).

The ledge between the two escarpments is fragile. Any weight in excess of 100 pounds loosens the whole mass and sends it tumbling down to the east. Any creature on the ledge when it falls must make a DC 10 Dexterity saving throw, taking 2d6 bludgeoning damage on a failure, or half as much damage on a success. The creature also falls [prone](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ProneCondition) on a failed save (see “[Being Prone](https://www.dndbeyond.com/sources/basic-rules/combat#BeingProne)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)).

### [5. Overpass](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#5Overpass)
...
One [goblin](https://www.dndbeyond.com/monsters/16907-goblin) stands watch on the bridge. It is hiding, and characters can spot it by succeeding on a Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check contested by the goblin’s Dexterity ([Stealth](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. This guard is lazy and inattentive. If no characters are using light sources, each character can attempt a Dexterity ([Stealth](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check against the goblin’s passive Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) score to creep by without being noticed.

If the goblin spots the adventurers, it signals the goblins in [area 7](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#7TwinPoolsCave) to release a flood (see the “[Flood!](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#Flood)” section), then fire arrows down at the characters.

_**Bridge.**_ This bridge spans the passage 20 feet above the stream. It’s possible to climb up the cavern walls from the lower passage to the bridge. The 20-foot-high walls are rough but slick with spray, requiring a successful DC 15 Strength ([Athletics](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check to climb.

The bridge has an Armor Class (AC) of 5 and 10 hit points. If the bridge is reduced to 0 hit points, it collapses. Creatures on the collapsing bridge must succeed on a DC 10 Dexterity saving throw or fall, taking 2d6 bludgeoning damage and landing [prone](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ProneCondition) (see “[Being Prone](https://www.dndbeyond.com/sources/basic-rules/combat#BeingProne)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)). Those who succeed hold onto the bridge and must climb it to safety.

#### [Flood!](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#Flood)

The large pools in [area 7](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#7TwinPoolsCave) have collapsible walls that can be yanked out of place to release a surge of water down the main passage of the lair. In the round after the goblins in area 7 are signaled by the lookout in area 5, they start knocking away the supports. In the following round on the goblins’ initiative count, a water surge pours from area 7 down to area 1.

The passage is suddenly filled with a mighty roar, as a huge surge of rushing water pours down from above!

The flood threatens all creatures in the tunnel. (Creatures on the bridge at area 5 are out of danger, as are any characters successfully climbing the cavern walls.) Any creature within 10 feet of the disused passage at [area 4](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#4SteepPassage) or the steps leading up to [area 3](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#3Kennel) can attempt a DC 10 Dexterity saving throw to avoid being swept away. A creature that fails to get out of the way can attempt a DC 15 Strength saving throw to hold on. On a failed save, the character is knocked [prone](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ProneCondition) and washed down to [area 1](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#1CaveMouth), taking 1d6 bludgeoning damage along the way.
...
### [6. Goblin Den](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#6GoblinDen)
...
Six [goblins](https://www.dndbeyond.com/monsters/16907-goblin) inhabit this den, and one of them is a leader with 12 hit points. The five ordinary goblins tend the cooking fire in the lower (northern) part of the cave near the entrance passage, while the leader rests in the upper (southern) part of the cave.

[Sildar Hallwinter](https://www.dndbeyond.com/monsters/22033-sildar-hallwinter), a human warrior, is held prisoner in this chamber. He is securely bound on the southern ledge of the cavern. The goblins have been beating and tormenting him, so he is weak and at 1 hit point.

The goblin leader, [Yeemik](https://www.dndbeyond.com/monsters/266410-yeemik), is second-in-command of the whole hideout. If he sees that the characters are getting the upper hand, he grabs Sildar and drags him over to the edge of the upper level. “Truce, or this human dies!” he shouts.

Yeemik wants to oust Klarg and become the new boss. If the adventurers agree to parley, Yeemik tries to convince them to kill Klarg in [area 8](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#8KlargsCave), promising to release Sildar when they bring back the bugbear’s head. Sildar groggily warns the characters that they shouldn’t trust the goblin, and he’s right. If the characters take the deal, Yeemik tries to force them to pay a rich ransom for Sildar even after they complete their part of the bargain.

If the characters refuse to parley, Yeemik shoves Sildar over the edge and continues with the fight. Sildar takes 1d6 bludgeoning damage from the fall, which is enough to drop him to 0 hit points. Quick-acting characters can try to stabilize him before he dies (see “[Damage and Healing](https://www.dndbeyond.com/sources/basic-rules/combat#DamageandHealing)” in the [Basic Rules](https://www.dndbeyond.com/sources/basic-rules)).

#### [Roleplaying Sildar](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#RoleplayingSildar)
...
#### [Developments](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GoblinDenDevelopments)

If he is rescued and healed, Sildar Hallwinter remains with the party but is anxious to reach Phandalin as quickly as possible. He doesn’t have any weapons or armor, but he can take a [shortsword](https://www.dndbeyond.com/equipment/30-shortsword) from a defeated goblin or use a weapon loaned to him by a character.
...
#### [Treasure](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#GoblinDenTreasure)
...
### [7. Twin Pools Cave](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#7TwinPoolsCave)
...
Three [goblins](https://www.dndbeyond.com/monsters/16907-goblin) guard this cave. If the goblin in [area 5](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#5Overpass) spotted the characters and warned the goblins here, they are ready for trouble. The noise of the waterfall means that the creatures in area 8 can’t hear any fighting that takes place here, and vice versa. Therefore, as soon as a fight breaks out here, one goblin flees to area 8 to warn Klarg.
...
### [8. Klarg’s Cave](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#8KlargsCave)
...
[![](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/01-002.fungi.png)](https://media.dndbeyond.com/compendium-images/lmop/M14LHJMMQhUuZ46S/01-002.fungi.png)

Klarg the [bugbear](https://www.dndbeyond.com/monsters/16817-bugbear) shares this cave with his mangy pet [wolf](https://www.dndbeyond.com/monsters/17062-wolf), Ripper, and two [goblins](https://www.dndbeyond.com/monsters/16907-goblin). The bugbear is filled with delusions of grandeur and views himself as a mighty warlord just beginning his career of conquest. He is not entirely sane, referring to himself in the third person (“Who dares defy Klarg?” or “Klarg will build a throne from your bones, puny ones!”). The goblins under his command resent his bullying.

_**Fire Pit.**_ The hot coals in the central fire pit deal 1 fire damage to any creature that enters the fire pit, or 1d6 fire damage to any creature that falls [prone](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ProneCondition) there. A creature can take each type of damage only once per round.
...
#### [Developments](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#KlargsCaveDevelopments)
...
If Klarg and company are not warned about possible attackers, the characters have a good chance to [surprise](https://www.dndbeyond.com/sources/basic-rules/combat#Surprise) them. The easiest way for the characters to achieve this is to climb the chimney from area 3, since Klarg does not expect an attack from that direction.

If the wolf is killed, the bugbear attempts to climb down the chimney to [area 3](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#3Kennel) and flee the cave complex.

#### [Treasure](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#KlargsCaveTreasure)

The captured stores are bulky, and the characters will need a wagon to transport them. If they return the supplies to the [Lionshield Coster](https://www.dndbeyond.com/sources/lmop/phandalin#LionshieldCoster) in Phandalin (see [part 2, “Phandalin”](https://www.dndbeyond.com/sources/lmop/phandalin)), they earn a reward of 50 gp and the friendship of Linene and her company.

In addition to the stolen provisions, Klarg has a treasure chest that contains 600 cp, 110 sp, two _[potions of healing](https://www.dndbeyond.com/equipment/71-potion-of-healing)_, and a jade statuette of a frog with tiny golden orbs for eyes (40 gp). The frog statuette is small enough to fit in a pocket or pouch.

### [What’s Next?](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#WhatsNext)

The next stage of the adventure takes place in Phandalin. The adventurers should have plenty of reasons to visit the town:

- If the characters began with the [“Meet Me in Phandalin”](https://www.dndbeyond.com/sources/lmop/introduction#AdventureHook) adventure hook, they can be paid by Barthen’s Provisions for delivering the wagonload of supplies.
...
It’s also possible that players might decide to do something different, such as striking out in search of [Cragmaw Castle](https://www.dndbeyond.com/sources/lmop/the-spiders-web#CragmawCastle) (in part 3 of the adventure). If that’s the case, skip ahead to that section.

#### [Awarding Experience Points](https://www.dndbeyond.com/sources/dnd/lmop/goblin-arrows#KlargsCaveAwardingExperiencePoints)
